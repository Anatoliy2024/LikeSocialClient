    ...
    >
      ...
      <clipPath id="sand-mound-bottom">
        <path
          ...
          className={style.sandMoundBottom}
        />
      </clipPath>
      ...
      <g transform="translate(2,2)">
        ...
        >
          ...
          <circle
            ...
            cx="26"
            strokeWidth={1}
            className={style.motionThin}
          />
        </g>

        <g transform="translate(13.75,9.25)" className={style.model}>
          <path
          ...
          <g strokeLinecap="round" stroke="hsl(35,90%,90%)">
            ...
            <line
              ...
              strokeDasharray="0.25 33.75"
              strokeWidth={1}
              className={style.sandGrainRight}
            />
            <line
              y2="31.5"
              x2="12.25"
          ...
          <g strokeWidth={2} strokeLinecap="round" opacity={0.7} fill="none">
            <path
              ...
              stroke="hsl(0,0%,100%)"
              className={style.glareTop}
            />
            <path
              transform="rotate(180,12.25,16.75)"
              d="M 19.437 3.421 C 19.437 3.421 19.671 6.454 17.914 8.846 C 16.157 11.238 14.5 11.5 14.5 11.5"
              stroke="hsla(0,0%,100%,0)"
              className={style.glareBottom}
            />
          </g>
