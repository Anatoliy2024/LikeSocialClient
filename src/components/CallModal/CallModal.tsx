...
export const CallModal = () => {
  ...
  // ✅ Фикс #1: убраны playRemoteStream и closeAudioContext отсюда.
  // Аудио управляется исключительно в useCall → onStream + hardCleanup.
  // CallModal отвечает только за UI.
      ...
      >
        ...
        {(status === "calling" || status === "incoming") && (
          <div className={styles.ringingContent}>
            ...
            <AvatarRing src={peerAvatar} alt={peerName ?? "?"} size={120} />
          ...
          <div className={styles.inCallContent}>
            ...
            {!hasLocalVideo && !hasRemoteVideo && (
              <div className={styles.avatarsRow}>
                ...
                <div className={styles.avatarBlock}>
                  <AvatarRing src={myAvatar} alt={myName ?? "You"} size={88} />
                  <span className={styles.avatarLabel}>{myName ?? "You"}</span>
                </div>
              </div>
            )}
            ...
            <div className={styles.controls}>
              <button
                className={`${styles.ctrlBtn} ${!isAudioEnabled ? styles.ctrlBtnOff : ""}`}
